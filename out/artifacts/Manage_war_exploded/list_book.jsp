...
<div class="nav">
    ...
    <a href="login.html" style="font-size:22px;color:orange;">注销</a>
    <a href="search.jsp" style="font-size:22px;color:orange;">查询</a>
    <a href="list_book3.jsp" style="font-size:22px;color:orange;">清单</a>
...
<table  border="1" class="q1" >
    ...
    <tr>
        ...
        <th style="width:190px; border: 1px solid black"> 姓名 </th>
       <th style="width:70px; border: 1px solid black"> 价格</th>
       <th style="width:70px; border: 1px solid black">数量</th>
       <th style="width:140px; border: 1px solid black">作者</th>
       <th style="width:140px; border: 1px solid black">联系电话</th>
       <th style="width:160px; border: 1px solid black">出版社</th>
       <th style="width:100px; border: 1px solid black">状态</th>
        ...
        else
        {
        	for(Book book:list)
        	{
        		...
        		<td style="text-align:center;">
        		 <form action="SelectAll3" method="post">
        		     <input type="hidden" name="name" value="<%=book.getName()%>">
        		    <input type="hidden" name="price" value="<%=book.getPrice()%>">
        		     <input type="submit" value="购买" style="margin-top:8px;font-size:17px;">
        		 </form>
